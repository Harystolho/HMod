...
import com.Hmod.container.ContainerBasic;
import com.Hmod.container.GuiInventoryBasic;
import com.Hmod.tileentity.TileEntityInventoryBasic;

public class GuiHandlerH implements IGuiHandler {
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world,
		...
		if (tileEntity instanceof TileEntityInventoryBasic) {
			TileEntityInventoryBasic tileEntityInventoryBasic = (TileEntityInventoryBasic) tileEntity;
			return new GuiInventoryBasic(player.inventory,
					tileEntityInventoryBasic);
		}
		return null;
	}
