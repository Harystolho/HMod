...
public class GuiHandler implements IGuiHandler{
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world,
		...
		case ContainerFurnace.GUI_FURNACE: return new ContainerFurnace(player.inventory, (TileEntityFurnace) world.getTileEntity(new BlockPos(x,y,z)));
		default: return null;
		}
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world,
		...
		case ContainerFurnace.GUI_FURNACE: return new GuiHFurnace(new ContainerFurnace(player.inventory, (TileEntityFurnace) world.getTileEntity(new BlockPos(x,y,z))));
		default: return null;
		}
	}
