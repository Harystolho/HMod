...
import com.Hmod.container.Container9x1;
import com.Hmod.tile_entity.TileEntityInventory9x1;

@SideOnly(Side.CLIENT)
public class GuiInventory9x1 extends GuiContainer {
	// This is the resource location for the background image for the GUI
	private static final ResourceLocation texture = new ResourceLocation(
			"hm", "textures/gui/hary_gui.png");
	private TileEntityInventory9x1 tileEntityInventoryBasic;

	public GuiInventory9x1(InventoryPlayer invPlayer,
			TileEntityInventory9x1 tile) {
		super(new Container9x1(invPlayer, tile));
