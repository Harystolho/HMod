package com.Hmod.render.tile_entity;
...
public class HaryChestRender extends TileEntitySpecialRenderer
{
    private static final ResourceLocation textureNormalDouble = new ResourceLocation(Reference.MODID + ":textures/blocks/large_hary_chest_normal.png");
    private static final ResourceLocation textureNormal = new ResourceLocation(Reference.MODID + ":textures/blocks/hary_chest_normal.png");
    private ModelChest simpleChest = new ModelChest();
    private ModelChest largeChest = new ModelLargeChest();
    private boolean isChristams;
    private static final String __OBFID = "CL_00000965";

    public HaryChestRender()
    {
