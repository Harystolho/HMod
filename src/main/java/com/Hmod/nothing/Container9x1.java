...
public class Container9x1 extends Container {
	// Stores a reference to the tile entity instance for later use
	private TileEntityInventory9x1 tileEntityInventoryBasic;
	...
	private final int TE_INVENTORY_FIRST_SLOT_INDEX = VANILLA_FIRST_SLOT_INDEX
			+ VANILLA_SLOT_COUNT;
	private final int TE_INVENTORY_SLOT_COUNT = 9;

	public Container9x1(InventoryPlayer invPlayer,
			TileEntityInventory9x1 tileEntityInventoryBasic) {
		...
		if (TE_INVENTORY_SLOT_COUNT != tileEntityInventoryBasic
				.getSizeInventory()) {
